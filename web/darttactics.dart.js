...
["", "darttactics.dart", , K, {
  ...
  main: [function() {
    ...
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(K.reverseText$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  ...
  reverseText: [function($event) {
    ...
    document.querySelector("#sample_text_id").textContent = C.JSInt_methods.toString$0(3);
  }, "call$1", "reverseText$closure", 2, 0, 8]
},
1],
]);
...
//# sourceMappingURL=darttactics.dart.js.map
//@ sourceMappingURL=darttactics.dart.js.map
